...
% TODOS:
% * I need to go back and create a separate branch for the T0.2 code and test it
% * This needs to be documented
% * Operating instructions need to be added
% * We need to decide what to do about V.0.3 in terms of this paper; should we add instructions
% * References section sould be done with bibtex
