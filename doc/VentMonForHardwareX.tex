...
(6) VentMon T0.3 PCB & PCB Design Files & MIT License &  \href{https://doi.org/10.5281/zenodo.4079170}{10.5281/zenodo.4079170} (see {\em design/pcb}) \\\hline
...
P2 &	Bleed Adapter	& 1 &	\$5.50 &	\$5.50 &	Oxygen Supply	& Plastic \\\hline
...
Note: The flow sensor is one of the most expensive and critical parts. Throughout mid-2020 there was a global shortage of flow sensors,
including the three electrically compatible with the VentMon as currently designed.
The SFM3400-33-D (disposable version \$40USD), Sensirion SFM3200-250 (\$145USD),  and Sensirion SFM3200-AW (\$180USD autoclavable version).
We shipped VentMons with all three depending on availability. The VentMon is not designed for use with humans, but if it were,
the autoclavable version would have the advantage of sanitizability of a complete sanitization procedure were designed.
This is important, as we hope the VentMon will be modified and integrated into a rapidly manufactured ventilator, for which
sanitization is critical.


The link below is to a spreadsheet which is includes the PCB-version as well, which is very similar accept
for the PCB itself. By following the link below, you can reach browsable URLs to most of the non-commodity parts. The specific
...
{\em The VentMon T0.2 is not meant to be used on human patients. }
...
{\em The VentMon T0.3 is not meant to be used on human patients. }
The purpose of the VentMon is to measure, log, validate and verify the performance of rapdily manufactured ventilators,
...
the functionality of a {\em breating simulator}, without being able to model the patient triggering a breath spontaneously.
...
as the humidity, FiO2, and temperature. Additionally, the beginning and ending of each breath is detected, and total volume
of the breath computed by integrating the flow.

Such calculations allows us to present the numbers on the right, which a typical of a commecial ventilator display, but
