...
Although it is beyond the scope of this paper to review or even comment on ventilation projects, a number of pandemic response ventilators have been reported on recently which seem to be candidates to benefit from the VentMon, if only because of its flow-sensing and oxygen sensing capabilities (most have pressure sensors in place) \cite{lai2020emergency,petsiuk2020partially,garmendia2020low,zuckerberg2020lung,galbiati2020mechanical}. Although most published reports include bench-top testing, this may have been done with an instrumented test lung which is not continuously available to the development teams as a VentMon might be. Additionally, most of the teams mentioned in a report on open source teams\cite{Fraunhofer2020} could make use of a VentMon.
...
\centering
\includegraphics[width=0.65\textwidth]{bme_and_qwiic_cable.JPG}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{bme_diagram.JPG}
\caption{Qwiic cable soldered to BME sensor assembly}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{flow_1.JPG}
\includegraphics[width=0.45\textwidth]{flow_2.JPG} \\
\includegraphics[width=0.45\textwidth]{flow_4.JPG}
\includegraphics[width=0.45\textwidth]{flow_3.JPG}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{adapters_1.JPG} \\
\includegraphics[width=0.6\textwidth]{adapters_2.JPG} \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{bmeinbox.JPG}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{ziptie.JPG}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{final_assembly_with_tape.JPG}
